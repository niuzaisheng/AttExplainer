...
# func() {
#     for j in FeatureAblation Occlusion KernelShap ShapleyValueSampling IntegratedGradients DeepLift LIME
#     do
#         echo "running $1 $j"
...
# export CUDA_VISIBLE_DEVICES=0
# func "emotion" > logs/emotion.out &
# export CUDA_VISIBLE_DEVICES=1
# func "sst2" > logs/sst2.out &
# export CUDA_VISIBLE_DEVICES=2
# func "snli" > logs/snli.out &
