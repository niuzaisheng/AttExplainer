...
import torch
from captum.attr import FeatureAblation,FeaturePermutation, Occlusion, ShapleyValueSampling, KernelShap
import numpy as np
...
if config.explain_method == "FeatureAblation":
    ...
    lig = EnhancedKernelShap(predict, transformer_model, dqn_model)
    original_lig = KernelShap(predict)
